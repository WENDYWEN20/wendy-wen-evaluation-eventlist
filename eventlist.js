document.addEventListener("DOMContentLoaded", async () => {
  ...
  function addEventRow(event) {
    ...
    document
      .getElementById(`saveBtn-${event.id}`)
      .addEventListener("click", () => saveEvent(event.id));
    document
      .getElementById(`deleteBtn-${event.id}`)
      .addEventListener("click", () => deleteEventHandler(event.id));
  }
  ...
  function addNewEventRow() {
    ...
    document
      .getElementById("saveNewEventBtn")
      .addEventListener("click", async () => {
        ...
        if (eventName && startDate && endDate) {
          ...
          //if eventName, startDate, endDate all three exists, the newEvent will be passed to backend as an argument
    ...
    document
      .getElementById("cancelNewEventBtn")
  ...
  // class="remove-btn" id="removeDateButton"
  const removeDateButton = document.getElementById("removeDateButton");
